function [tc_lon,tc_lat,tc_p,tc_w,tw_lon,tw_lat] = TC_center_DMC(lon,lat,slp,swd,TLM,TLN)
...
for i = II-TLM_L:II+TLM_L
    for j= JJ-TLM_L:JJ+TLM_L
        var = slp(II-TLM_L:II+TLM_L,JJ-TLM_L:JJ+TLM_L);
